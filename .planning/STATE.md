...
Last activity: 2026-06-07 - Completed quick task 260607-fnp: per-part font-size + cover-size/grid-columns appearance settings (app-wide via CSS vars) + richer Data tab + Translation page restructure (lyrics-first, dividers) + restored Bio language picker (default Auto)
