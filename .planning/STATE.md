...
Last activity: 2026-06-07 - Completed quick task 260607-f4y: names default to no-translation + Last.fm-info→Bio-info (auto by app lang) + NowPlaying marquee title/artist, hidden genre chips, error banner
